...
namespace FrotaApp.Domain.Validations
{
    ...
    {
        public readonly VehicleEntity _vehicle;
        ...
        public VehicleValidations MinNameLength()
        {
            if (_vehicle.Name.Length < 3)
                _vehicle.PullNotification(new Notification("Name", "O nome deve conter um mínimo de 3 caracteres"));
        ...
        public VehicleValidations MaxNameLength()
        {
            if (_vehicle.Name.Length > 12)
                _vehicle.PullNotification(new Notification("Name", "Quantidade máxima de caracteres ultrapassada"));
